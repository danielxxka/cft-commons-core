...
public class EncryptUtils {
	...
	public static final int HASH_INTERATIONS_1024 = 1024;
	 ...
	 * @throws Exception
	 */
	public static String encryptSHA512(String string) throws Exception {
		return new String(DigestUtils.sha512(string));
	}
	...
	public static String entryptPassword(String plainPassword, byte[] salt){
		...
		byte[] hashPassword = EncryptUtils.sha1(plainPassword.getBytes(), salt, HASH_INTERATIONS_1024);
