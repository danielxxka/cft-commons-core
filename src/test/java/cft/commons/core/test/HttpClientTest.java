...
public class HttpClientTest {
	...
	private static void testProxy() throws Exception {
		...
		HttpHost proxy1 = new HttpHost("192.168.1.20", 8080, "HTTP");
	...
	private static void testPost() throws Exception {
		...
		MultipartEntity entity3 = new MultipartEntity(HttpMultipartMode.BROWSER_COMPATIBLE, null,
	...
	private static void testURIUtils() throws Exception {
		...
		URI uri2 = URIUtils
				.createURI("http", "www.baidu.com", -1, "/s", URLEncodedUtils.format(qparams, "UTF-8"), null);
